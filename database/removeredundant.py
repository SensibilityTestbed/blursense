...
places = ['school', 'park', 'hotel', 'motel', 'resort', 'canyon', 'lake', 'inn', 'spring', 'mine', 'hall', 'canal', 'beach', 'suite', 'peak', 'ridge', 'saddle', 'station', 'gulch', 'laboratory', 'falls', 'memorial', 'heliport', 'transport', 'university', 'college', 'division', 'wilderness', 'reservoir', 'wharf', 'department', 'cemetery', 'mausoleum', 'siding', 'office', 'service', 'museum', 'bus stop', 'library', 'building', 'campus', 'campground', 'camping', 'campsite', 'shopping', 'plaza', 'zoo', 'hospital', 'swamp', 'facility', 'island', 'travelodge', 'super 8', 'ritz', 'marina', 'landfill', 'reef', 'student', 'union', 'north', 'south', 'bureau', 'congregation', 'shrine', 'number', 'reservation', 'theatre', 'sanatorium', 'acres', 'ministry', 'ministries', 'corner', 'lagoon', 'ravine', 'peninsula', 'basin', 'square', 'well', 'best western', 'sheraton', 'hilton', 'marriott', '\-AM', '\-FM', '\-TV']
